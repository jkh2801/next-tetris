...
const Web = () => {
  ...
  return (
    <main className="w-screen h-screen flex justify-center items-center">
      <Bg />
      {gameStatus === "main" && (
        <div className="rounded border-4 border-slate-200 w-[440px] h-[568px] bg-black z-30 p-6 text-white text-sm overflow-y-scroll">
          ...
          <div className="mt-6">최종 점수</div>
          <div className="mt-3">
            최종 점수 = 한 줄 채운 라인 갯수 + 획득한 송편 수 + 플레이 시간{" "}
            {"(1초당 1점)"}
          </div>
          <div className="mt-6">Keyboard</div>
          <div className="mt-3">
            <Image
              src="/web_keyboard.png"
              alt="keyboard"
              width={400}
              height={1000}
            />
      ...
      {gameStatus === "start" && (
        <div className="rounded border-4 border-slate-200 bg-sky-600 overflow-hidden z-30">
          <div className="h-20 border-b-4 border-slate-200 flex justify-center items-center">
            <Image
              src="/web_keyboard_summary.png"
              alt="keyboard"
              width={300}
              height={60}
            />
          ...
          <div className="flex">
            <div className="w-24 border-r-4 border-slate-200">
              ...
              <ScoreBox playerController={playerController} />
            </div>
            <TetrisBox
              ...
              unitSize={24}
            />
            <div className="w-24 border-l-4 border-slate-200">
              <div className="flex justify-center items-center h-12 text-white">
                Next
              </div>
              <NextBox playerController={playerController} />
            </div>
          </div>
        </div>
      )}
      {gameStatus === "end" && (
        <div className="rounded border-4 border-slate-200 w-[440px] h-[568px] bg-black z-30 p-6 text-white text-xl overflow-y-scroll">
